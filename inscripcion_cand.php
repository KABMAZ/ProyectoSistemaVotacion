     ...
     <li><a href="registro_votante.php">Registro De Votante</a></li> 
      <li><a href="cerrar.php" class="label label-primary">Cerrar Sesion</a></li>
        <br>
            ...
            <h4>Dui</h4><input type="text" name="dui" value="" class="form-control" name="textfield" id="textfield" onkeydown="return validarNumeros(event)"
                       placeholder="00000000-0"  required="on" maxlength="10"/><br>
            Apellido:<input type="text" onkeydown="return validarLetras(event)" name="Apellido" value="" class="form-control" required="on"/>
            Nombre:<input type="text" onkeydown="return validarLetras(event)" name="Nombre" value="" class="form-control" required="on"/>
            Departamento:<input type="text" onkeydown="return validarLetras(event)" name="Departamento" value="" class="form-control" required="on"/>
            Municipio:<input type="text" onkeydown="return validarLetras(event)" name="Municipio" value="" class="form-control" required="on "/>
