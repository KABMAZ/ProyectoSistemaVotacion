...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            ...
            $sql= "SELECT * FROM voto WHERE candidatura='presidentes'";
              $que = $db->execute($sql);
...
<div id="container" style="min-width: 600px; height: 300px; max-width: 800px; margin: 0 auto"></div>
<center>
<p>Volver A Menu Votar: <a href="../dui.php">Volver</a></p>
</center>
